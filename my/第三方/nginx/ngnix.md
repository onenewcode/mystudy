...
![1586368250085](img/1586368250085.png)
...
**概述**: sendfile 的作用就是开启一个缓冲区，把之前放过的资源放在缓存区内，再次访问时，只需要访问缓存区的内容，而不需要通过复杂的转跳。
...
![1587655397104](img/1587655397104.png)



![1587665814562](img/1587665814562.png)
...
![1587361606028](img/1587361606028.png)
...
![](img/1581769820325.png)

后台服务器可以根据获取到的这个Referer信息来判断是否为自己信任的网站地址，如果是则放行继续访问，如果不是则可以返回403(服务端拒绝访问)的状态信息。

在本地模拟上述的服务器效果：

![](img/1581769079083.png)
...
![1589729000713](img/1589729000713.png)
...
![](img/1581847577947.png)

(6)设置完成后，再次通过浏览器访问服务端

![1589729479920](img/1589729479920.png)
...
![1584602513812](img/1584602513812.png)
...
![1584602887881](img/1584602887881.png)
...
![1591010973996](img/1591010973996.png)
...
![1584693830966](img/1584693830966.png)
...
![1590248160635](img/1590248160635.png)
...
![1591706748677](img/1591706748677.png)
...
![1591809623736](img/1591809623736.png)
...
![1584941470457](img/1584941470457.png)
...
![1584943399597](img/1584943399597.png)
...
![1604636592232](img/1604636592232.png)
...
![1604636706604](img/1604636706604.png)

![1604636719140](img/1604636719140.png)

## ngx_lua的使用

使用Lua编写Nginx脚本的基本构建块是指令。指令用于指定何时运行用户Lua代码以及如何使用结果。下图显示了执行指令的顺序。

![1604717983815](img/1604717983815.png)
...
![1604726959698](img/1604726959698.png)
