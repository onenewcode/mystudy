...
- 第一步：从结果中获取source。hit，这部分是非高亮结果，json字符串。
- 第二步：获取高亮结果。hit.highlight()，返回值是一个Map，key是高亮字段名称，值是HighlightField对象，代表高亮值
- 第三步：从map中根据高亮字段名称，获取高亮字段值对象HighlightField
- 第四步：从HighlightField中获取Fragments.这部分就是真正的高亮字符串了
